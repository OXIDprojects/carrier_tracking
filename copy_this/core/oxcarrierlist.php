...
class oxCarrierList extends oxList
{
    ...
    {
        $sSelect = "SELECT oxtrackadr, oxtitle FROM oxcarriertracking WHERE oxactive = '1' ORDER BY oxtitle ";
    ...
    {
        if ( $oA->oxcarriertracking__oxorder->value != $oB->oxcarriertracking__oxorder->value ) {
            if ( $oA->oxcarriertracking__oxorder->value < $oB->oxcarriertracking__oxorder->value ) {
                return -1;
            } else {
                return 1;
        ...
        $sACodedTitle = preg_replace( $aReplaceWhat, $aReplaceTo, $oA->oxcarriertracking__oxtitle->value );
        $sBCodedTitle = preg_replace( $aReplaceWhat, $aReplaceTo, $oB->oxcarriertracking__oxtitle->value );
